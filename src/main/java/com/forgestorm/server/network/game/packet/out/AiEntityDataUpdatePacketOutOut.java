...
public class AiEntityDataUpdatePacketOutOut extends AbstractPacketOut {
    ...
    public AiEntityDataUpdatePacketOutOut(final Player packetReceiver, final AiEntity aiEntity, final byte dataBits) {
