            ...
            try (
                ...
                if (loginState.getLoginSuccess()) {
                    ...
                    networkManager.getAuthenticationManager().addLoginUser(uuid,
                            new AuthenticatedUser(clientSocket.getInetAddress().getHostAddress(), loginState.getUserId(), loginState.getUsername(), loginState.getSecondaryGroupIds(), loginState.isAdmin(), loginState.isModerator()));
